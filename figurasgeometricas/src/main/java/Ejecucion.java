...
public class Ejecucion {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    calculoTrapecio(scanner, trapecio);
                    break;

                case 2:
                    calculoParalelogramo(scanner, paralelogramo);
                    break;

                case 3:
                calculoOctagono(scanner, octagono);
                    break;
    ...
    private static void calculoTrapecio(Scanner scanner, Trapecio trapecio) {
    ...
    private static void calculoParalelogramo(Scanner scanner, Paralelogramo paralelogramo) {
    ...
    private static void calculoOctagono(Scanner scanner, Octagono octagono) {
